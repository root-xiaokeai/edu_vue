      ...
      <div class="course-list">
        ...
        <div class="course-item" v-for="course in course_list">
          ...
          <div class="course-info">
            <h3>
              <a href="javascript:;" @click="detail(course.id)">{{ course.name }}</a>
            ...
            <ul class="lesson-list">
              <li v-for="(lesson, key) in course.lesson_list" :key="key">
                ...
                <span class="free" v-if="true">免费</span>
              </li>

            </ul>
            <div class="pay-box">
              <span class="discount-type">{{course.course_types}}</span>
  ...
  export default {
    ...
    methods: {
      ...
      get_course_list() {
        ...
        this.$axios.get(`http://127.0.0.1:8000/course/list_filter/`, {
          params: filters
        }).then(response => {
      ...
      // 获取所有分类信息
      get_all_category() {
        this.$axios.get(`http://127.0.0.1:8000/course/category/`).then(response => {
