<template>
  <div class="cart">
    ...
    <div class="cart-info">
      ...
      <div class="cart-item" v-for="value in order_list">
        <el-row>
          ...
          <el-col :span="4" class="course-price">¥{{ value.price }}</el-col>
        </el-row>
      </div>
      ...
      <div class="calc">
        <el-row class="pay-row">
          ...
          <el-col :span="8">
            <span class="alipay" @click="pay_type=1"><img src="../../static/image/alipay2.png" alt=""></span>
            <span class="alipay wechat" @click="pay_type=2"><img src="../../static/image/wechat.png" alt=""></span>
          </el-col>
          <el-col :span="8" class="count">实付款： <span>¥{{ price }}</span></el-col>
  ...
  export default {
    ...
    methods: {
      ...
      payOrder() {
        ...
        this.$axios.post(`http://127.0.0.1:8000/cart/orders/`, {
          ...
          alert('支付成功');
          // 支付
          this.$axios.get(`http://127.0.0.1:8000/payments/ali/`, {
            params: {
      ...
      get_order() {
        ...
        this.$axios.get(`http://127.0.0.1:8000/cart/order/`, {
          ...
          console.log(res.data);
          // 购物车中待付款数据
          this.order_list = res.data.course_list;
          // 总价
